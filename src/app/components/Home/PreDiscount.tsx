...
const PreDiscount = () => {
  return (
    ...
    <div className="relative bg-white/90 dark:bg-[#484848] rounded-lg mb-6 md:mb-0 md:mr-4 w-full md:w-[450px] h-[270px]">
      <div className="relative p-4 w-full h-full bg-[#f7f8f9] dark:bg-[#484848] brightness-110 shadow-lg shadow-[#060607] transition-transform duration-300 hover:shadow-xl hover:scale-105">
